...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({ isOpen, onClose }) => {
  // Define defaultSettings first before using it
  ...
  // Sincronizza localSettings solo quando il componente si apre
  useEffect(() => {
  ...
  const handleToggleNotifications = async () => {
    if (!localSettings.enabled) {
      ...
      if (result === 'granted') {
        ...
        toast.error('Errore nella richiesta di permesso');
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-gray-900 dark:text-white">Promemoria pasti</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-gray-900 dark:text-white">Promemoria acqua</span>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-gray-900 dark:text-white">Promemoria esercizio</span>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
              ...
              {activeTab === 'schedule' && (
                <div className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-gray-900 dark:text-white">Promemoria giornaliero</span>
                      <input
                        type="time"
                        className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
export const NotificationButton: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  // Verifica di sicurezza per evitare errori se notificationSettings è undefined
